...
summary: ''
authors: []
lastmod: '2020-04-19T14:26:14-05:00'
featured: yes
image:
...
Overall notes about `gt`: I like it! I'm still learning the syntax but it seems intuitive and user-friendly. It's worth noting at the beginning of this post that the tables are rendered a little differently via blogdown than they would be if they were just knit into an html file. Therefore, **please don't view this page in dark mode**...you won't be able see half the table rows. I believe this problem should be fixed with the next release of `gt` on CRAN.
