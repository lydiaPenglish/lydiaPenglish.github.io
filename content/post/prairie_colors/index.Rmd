...
I've been inspired by other R packages that have created color palettes [based on living organisms](https://nschiett.github.io/fishualize/index.html). Naturally I decided to try to make a color palette using prairie species. I want to note right away that I didn't do anything fancy when chosing colors. I merely used the [instant eyedropped](http://instant-eyedropper.com/) tool to hover over different pixels in my photos and wrote down the hex codes. Obviously colors will vary based on lighting and shading. I had to be a little arbitrary in picking the essential pixel shades. If a photo is taken from somewhere else (i.e. is not my own) then I've noted it as such. 
...
Side oats gramma grass (*Bouteloua curtipendula* - one of the funner scientific names to pronouce I may add) is a shorter grass species that has a lovely spike of florets that hang down along one axis. I haven't gotten a good photo of Side oats while it's flowering so I snagged a photo from Prairie Moon Nursery's [website](https://www.prairiemoon.com/bouteloua-curtipendula-side-oats-grama-prairie-moon-nursery.html). When flowering, Side oats has some beauitfully red anthers and pollen. 
